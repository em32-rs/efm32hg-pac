...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CC1_CTRL_SPEC, u8, MODE_A, 2, O>;
...
pub type OUTINV_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC1_CTRL_SPEC, bool, O>;
...
pub type COIST_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC1_CTRL_SPEC, bool, O>;
...
pub type COFOA_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CC1_CTRL_SPEC, u8, COFOA_A, 2, O>;
...
pub type CUFOA_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CC1_CTRL_SPEC, u8, CUFOA_A, 2, O>;
...
pub type PRSSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CC1_CTRL_SPEC, u8, PRSSEL_A, 3, O>;
...
pub type INSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC1_CTRL_SPEC, bool, O>;
#[doc = "Field `FILT` reader - Digital Filter"]
pub type FILT_R = crate::BitReader<bool>;
#[doc = "Field `FILT` writer - Digital Filter"]
pub type FILT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC1_CTRL_SPEC, bool, O>;
...
pub type ICEVCTRL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CC1_CTRL_SPEC, u8, ICEVCTRL_A, 2, O>;
...
pub type PRSCONF_R = crate::BitReader<bool>;
#[doc = "Field `PRSCONF` writer - PRS Configuration"]
pub type PRSCONF_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC1_CTRL_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 28 - PRS Configuration"]
    #[inline(always)]
    pub fn prsconf(&mut self) -> PRSCONF_W<28> {
        PRSCONF_W::new(self)
    }
