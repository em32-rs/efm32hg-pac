...
pub mod lfbclken0;
#[doc = "LFCCLKEN0 (rw) register accessor: an alias for `Reg<LFCCLKEN0_SPEC>`"]
...
pub mod lock;
#[doc = "USBCRCTRL (rw) register accessor: an alias for `Reg<USBCRCTRL_SPEC>`"]
pub type USBCRCTRL = crate::Reg<usbcrctrl::USBCRCTRL_SPEC>;
#[doc = "USB Clock Recovery Control"]
pub mod usbcrctrl;
#[doc = "USHFRCOCTRL (rw) register accessor: an alias for `Reg<USHFRCOCTRL_SPEC>`"]
pub type USHFRCOCTRL = crate::Reg<ushfrcoctrl::USHFRCOCTRL_SPEC>;
#[doc = "USHFRCO Control"]
pub mod ushfrcoctrl;
#[doc = "USHFRCOTUNE (rw) register accessor: an alias for `Reg<USHFRCOTUNE_SPEC>`"]
pub type USHFRCOTUNE = crate::Reg<ushfrcotune::USHFRCOTUNE_SPEC>;
#[doc = "USHFRCO Frequency Tune"]
pub mod ushfrcotune;
#[doc = "USHFRCOCONF (rw) register accessor: an alias for `Reg<USHFRCOCONF_SPEC>`"]
