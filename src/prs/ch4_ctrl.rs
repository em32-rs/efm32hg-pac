#[doc = "Register `CH4_CTRL` reader"]
pub struct R(crate::R<CH4_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH4_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH4_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH4_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH4_CTRL` writer"]
pub struct W(crate::W<CH4_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH4_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH4_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH4_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SIGSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH4_CTRL_SPEC, u8, u8, 3, O>;
...
pub type SOURCESEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH4_CTRL_SPEC, u8, SOURCESEL_A, 6, O>;
...
pub type EDSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CH4_CTRL_SPEC, u8, EDSEL_A, 2, O>;
...
pub type ASYNC_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH4_CTRL_SPEC, bool, O>;
impl R {
...
pub struct CH4_CTRL_SPEC;
impl crate::RegisterSpec for CH4_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch4_ctrl::R](R) reader structure"]
impl crate::Readable for CH4_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ch4_ctrl::W](W) writer structure"]
impl crate::Writable for CH4_CTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CH4_CTRL to value 0"]
impl crate::Resettable for CH4_CTRL_SPEC {
    #[inline(always)]
