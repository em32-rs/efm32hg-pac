...
pub struct R(crate::R<CH3_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH3_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH3_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH3_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH3_CTRL` writer"]
pub struct W(crate::W<CH3_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH3_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH3_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH3_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SIGSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH3_CTRL_SPEC, u8, u8, 3, O>;
...
pub type EDSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CH3_CTRL_SPEC, u8, EDSEL_A, 2, O>;
...
pub type ASYNC_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH3_CTRL_SPEC, bool, O>;
impl R {
