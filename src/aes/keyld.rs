...
pub struct KEYLD_R(crate::FieldReader<u32, u32>);
impl KEYLD_R {
    pub(crate) fn new(bits: u32) -> Self {
        KEYLD_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for KEYLD_R {
...
impl R {
    ...
    pub fn keyld(&self) -> KEYLD_R {
        KEYLD_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - Key Low Access D"]
