...
pub struct R(crate::R<DIEP2_TSIZ_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DIEP2_TSIZ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DIEP2_TSIZ_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DIEP2_TSIZ_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DIEP2_TSIZ` writer"]
pub struct W(crate::W<DIEP2_TSIZ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DIEP2_TSIZ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DIEP2_TSIZ_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DIEP2_TSIZ_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type XFERSIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DIEP2_TSIZ_SPEC, u32, u32, 19, O>;
#[doc = "Field `PKTCNT` reader - Packet Count"]
pub type PKTCNT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PKTCNT` writer - Packet Count"]
pub type PKTCNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DIEP2_TSIZ_SPEC, u16, u16, 10, O>;
#[doc = "Field `MC` reader - Multi Count"]
pub type MC_R = crate::FieldReader<u8, u8>;
#[doc = "Field `MC` writer - Multi Count"]
pub type MC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DIEP2_TSIZ_SPEC, u8, u8, 2, O>;
impl R {
