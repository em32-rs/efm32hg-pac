...
pub struct R(crate::R<DIEP0INT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DIEP0INT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DIEP0INT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DIEP0INT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DIEP0INT` writer"]
pub struct W(crate::W<DIEP0INT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DIEP0INT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DIEP0INT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DIEP0INT_SPEC>) -> Self {
        W(writer)
    }
}
