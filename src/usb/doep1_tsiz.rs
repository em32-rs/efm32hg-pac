...
pub struct R(crate::R<DOEP1_TSIZ_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DOEP1_TSIZ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DOEP1_TSIZ_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DOEP1_TSIZ_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DOEP1_TSIZ` writer"]
pub struct W(crate::W<DOEP1_TSIZ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DOEP1_TSIZ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DOEP1_TSIZ_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DOEP1_TSIZ_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type XFERSIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DOEP1_TSIZ_SPEC, u32, u32, 19, O>;
#[doc = "Field `PKTCNT` reader - Packet Count"]
pub type PKTCNT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PKTCNT` writer - Packet Count"]
pub type PKTCNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DOEP1_TSIZ_SPEC, u16, u16, 10, O>;
