...
pub struct R(crate::R<DIEP1_DMAADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DIEP1_DMAADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DIEP1_DMAADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DIEP1_DMAADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DIEP1_DMAADDR` writer"]
pub struct W(crate::W<DIEP1_DMAADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DIEP1_DMAADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DIEP1_DMAADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DIEP1_DMAADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DMAADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DIEP1_DMAADDR_SPEC, u32, u32, 32, O>;
impl R {
