#[doc = "Register `DOEP2_CTL` reader"]
pub struct R(crate::R<DOEP2_CTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DOEP2_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DOEP2_CTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DOEP2_CTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DOEP2_CTL` writer"]
pub struct W(crate::W<DOEP2_CTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DOEP2_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DOEP2_CTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DOEP2_CTL_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Device OUT Endpoint x+1 Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [doep2_ctl](index.html) module"]
pub struct DOEP2_CTL_SPEC;
impl crate::RegisterSpec for DOEP2_CTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [doep2_ctl::R](R) reader structure"]
impl crate::Readable for DOEP2_CTL_SPEC {
    type Reader = R;
}
