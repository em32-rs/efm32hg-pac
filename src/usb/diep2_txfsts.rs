...
pub struct R(crate::R<DIEP2_TXFSTS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DIEP2_TXFSTS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DIEP2_TXFSTS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DIEP2_TXFSTS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `SPCAVAIL` reader - TxFIFO Space Available"]
pub struct SPCAVAIL_R(crate::FieldReader<u16, u16>);
impl SPCAVAIL_R {
    pub(crate) fn new(bits: u16) -> Self {
        SPCAVAIL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SPCAVAIL_R {
...
#[doc = "Device IN Endpoint x+1 Transmit FIFO Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [diep2_txfsts](index.html) module"]
pub struct DIEP2_TXFSTS_SPEC;
impl crate::RegisterSpec for DIEP2_TXFSTS_SPEC {
    type Ux = u32;
}
