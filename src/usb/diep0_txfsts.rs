...
pub struct R(crate::R<DIEP0_TXFSTS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DIEP0_TXFSTS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DIEP0_TXFSTS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DIEP0_TXFSTS_SPEC>) -> Self {
        R(reader)
    }
}
