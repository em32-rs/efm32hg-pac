...
pub struct R(crate::R<DOEP0_INT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DOEP0_INT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DOEP0_INT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DOEP0_INT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DOEP0_INT` writer"]
pub struct W(crate::W<DOEP0_INT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DOEP0_INT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DOEP0_INT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DOEP0_INT_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type XFERCOMPL_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEP0_INT_SPEC, bool, O>;
...
pub type EPDISBLD_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEP0_INT_SPEC, bool, O>;
#[doc = "Field `AHBERR` reader - AHB Error"]
pub type AHBERR_R = crate::BitReader<bool>;
#[doc = "Field `AHBERR` writer - AHB Error"]
pub type AHBERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEP0_INT_SPEC, bool, O>;
#[doc = "Field `SETUP` reader - Setup Phase Done"]
pub type SETUP_R = crate::BitReader<bool>;
#[doc = "Field `SETUP` writer - Setup Phase Done"]
pub type SETUP_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEP0_INT_SPEC, bool, O>;
...
pub type OUTTKNEPDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEP0_INT_SPEC, bool, O>;
...
pub type STSPHSERCVD_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEP0_INT_SPEC, bool, O>;
...
pub type BACK2BACKSETUP_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEP0_INT_SPEC, bool, O>;
...
pub type PKTDRPSTS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEP0_INT_SPEC, bool, O>;
#[doc = "Field `BBLEERR` reader - Babble Error"]
pub type BBLEERR_R = crate::BitReader<bool>;
#[doc = "Field `BBLEERR` writer - Babble Error"]
pub type BBLEERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEP0_INT_SPEC, bool, O>;
...
pub type NAKINTRPT_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEP0_INT_SPEC, bool, O>;
...
pub type STUPPKTRCVD_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEP0_INT_SPEC, bool, O>;
impl R {
...
pub struct DOEP0_INT_SPEC;
impl crate::RegisterSpec for DOEP0_INT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [doep0_int::R](R) reader structure"]
impl crate::Readable for DOEP0_INT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [doep0_int::W](W) writer structure"]
impl crate::Writable for DOEP0_INT_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DOEP0_INT to value 0"]
impl crate::Resettable for DOEP0_INT_SPEC {
    #[inline(always)]
