...
pub type USHFRCOEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OSCENCMD_SPEC, bool, O>;
#[doc = "Field `USHFRCODIS` writer - USHFRCO Disable"]
pub type USHFRCODIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, OSCENCMD_SPEC, bool, O>;
impl W {
    ...
    #[inline(always)]
    pub fn ushfrcoen(&mut self) -> USHFRCOEN_W<10> {
        USHFRCOEN_W::new(self)
    }
    #[doc = "Bit 11 - USHFRCO Disable"]
    #[inline(always)]
    pub fn ushfrcodis(&mut self) -> USHFRCODIS_W<11> {
