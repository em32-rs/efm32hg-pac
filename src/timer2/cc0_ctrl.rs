...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CC0_CTRL_SPEC, u8, MODE_A, 2, O>;
...
pub type COIST_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC0_CTRL_SPEC, bool, O>;
...
pub type PRSSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CC0_CTRL_SPEC, u8, PRSSEL_A, 3, O>;
...
pub type INSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC0_CTRL_SPEC, bool, O>;
#[doc = "Field `FILT` reader - Digital Filter"]
pub type FILT_R = crate::BitReader<bool>;
#[doc = "Field `FILT` writer - Digital Filter"]
pub type FILT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC0_CTRL_SPEC, bool, O>;
...
pub type PRSCONF_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC0_CTRL_SPEC, bool, O>;
impl R {
