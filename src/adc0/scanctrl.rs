...
pub struct INPUTMASK_R(crate::FieldReader<u8, u8>);
impl INPUTMASK_R {
    pub(crate) fn new(bits: u8) -> Self {
        INPUTMASK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for INPUTMASK_R {
...
pub struct INPUTMASK_W<'a> {
    w: &'a mut W,
}
impl<'a> INPUTMASK_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
