...
pub struct MASTERDIS_W<'a> {
    w: &'a mut W,
}
impl<'a> MASTERDIS_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct RXBLOCKEN_W<'a> {
    w: &'a mut W,
}
impl<'a> RXBLOCKEN_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct RXBLOCKDIS_W<'a> {
    w: &'a mut W,
}
impl<'a> RXBLOCKDIS_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
