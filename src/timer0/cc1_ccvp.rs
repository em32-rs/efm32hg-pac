...
pub struct R(crate::R<CC1_CCVP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CC1_CCVP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CC1_CCVP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CC1_CCVP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `CCVP` reader - CC Channel Value Peek"]
pub struct CCVP_R(crate::FieldReader<u16, u16>);
impl CCVP_R {
    pub(crate) fn new(bits: u16) -> Self {
        CCVP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CCVP_R {
...
#[doc = "CC Channel Value Peek Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cc1_ccvp](index.html) module"]
