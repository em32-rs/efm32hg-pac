...
pub struct R(crate::R<PB_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PB_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PB_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PB_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PB_CTRL` writer"]
pub struct W(crate::W<PB_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PB_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PB_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PB_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DRIVEMODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PB_CTRL_SPEC, u8, DRIVEMODE_A, 2, O>;
...
#[doc = "Port Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pb_ctrl](index.html) module"]
...
#[doc = "`reset()` method sets PB_CTRL to value 0"]
