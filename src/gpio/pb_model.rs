...
pub struct R(crate::R<PB_MODEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PB_MODEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PB_MODEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PB_MODEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PB_MODEL` writer"]
pub struct W(crate::W<PB_MODEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PB_MODEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PB_MODEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PB_MODEL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Pin 0 Mode\n\nValue on reset: 0"]
...
#[doc = "Port Pin Mode Low Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pb_model](index.html) module"]
pub struct PB_MODEL_SPEC;
impl crate::RegisterSpec for PB_MODEL_SPEC {
    type Ux = u32;
}
