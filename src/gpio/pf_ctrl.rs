...
pub struct R(crate::R<PF_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PF_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PF_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PF_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PF_CTRL` writer"]
pub struct W(crate::W<PF_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PF_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PF_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PF_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
