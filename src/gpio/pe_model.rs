...
pub struct R(crate::R<PE_MODEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PE_MODEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PE_MODEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PE_MODEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PE_MODEL` writer"]
pub struct W(crate::W<PE_MODEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PE_MODEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PE_MODEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PE_MODEL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MODE0_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PE_MODEL_SPEC, u8, MODE0_A, 4, O>;
...
pub type MODE1_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PE_MODEL_SPEC, u8, MODE1_A, 4, O>;
...
pub type MODE2_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PE_MODEL_SPEC, u8, MODE2_A, 4, O>;
...
pub type MODE3_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PE_MODEL_SPEC, u8, MODE3_A, 4, O>;
...
pub type MODE4_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PE_MODEL_SPEC, u8, MODE4_A, 4, O>;
...
pub type MODE5_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PE_MODEL_SPEC, u8, MODE5_A, 4, O>;
...
pub type MODE6_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PE_MODEL_SPEC, u8, MODE6_A, 4, O>;
...
pub type MODE7_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PE_MODEL_SPEC, u8, MODE7_A, 4, O>;
