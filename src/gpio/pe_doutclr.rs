...
pub struct W(crate::W<PE_DOUTCLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PE_DOUTCLR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<PE_DOUTCLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PE_DOUTCLR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Port Data Out Clear Register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pe_doutclr](index.html) module"]
